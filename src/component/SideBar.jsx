...
import lightIcon from "../assets/icon-dark-theme.svg";
        ...
        <div>
              ...
              <div className="flex flex-col h-[70vh] justify-between ">
                <div>
                  {boards.map((board, index) => (
                    <div
                      className={`flex items-baseline mb-100 space-x-2 px-5 mr-8 rounded-r-full duration-500 ease-in-out py-4 cursor-pointer hover:bg-[#635fc71a] hover:text-[#635fc7] dark:hover:bg-white dark:hover:text-[#635fc7] dark:text-white ${
                        board.isActive &&
                  ...
                  <div
                    ...
                    className="flex items-baseline space-x-2 mr-8 rounded-r-full duration-500 ease-in-out cursor-pointer text-[#635fc7] px-5 py-4 hover:bg-[#635fc7] dark:hover:bg-white "
                  >
                    <img src={boardIcon} alt="s" className="h-4" />
          ...
          {isSideBarOpen ? (
            ...
            <div
              ...
              className="absolute p-5 bottom-0"
            >
              <img src={showSidebarIcon} alt="sidebaricon" />
            </div>
          )}
        </div>
      </div>
